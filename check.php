<?php
    ...
    if(isset($_POST["custname2"]) && isset($_POST["custnum2"])){
        ...
        $qry = "insert into booking(user,bookingid,name,phno,eventname,eventid,seat,totalamount,startdate,enddate) values
        ('$user','$bid','$name1','$ph1','$event','$eventid','$seat1','$amt','$sdate','$edate');
        insert into details(user,bookingid,name1,phno1,eventname,eventid,seat1,totalamount,startdate,enddate) values
        ('$user','$bid','$name1','$ph1','$event','$eventid','$seat1','$amt','$sdate','$edate');
        update events set s1qty=s1qty-1 where eventname='$event' and eventid='$eventid' and startdate='$sdate' and enddate='$edate'";
